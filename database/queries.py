...
create_tables_queries = [
    f"""
        CREATE TABLE `{GROUPS_CONTENTS_TABLE_PATH}`
        (
            `chat_id` Int64,
            `language` String,
            `group_id` String,
    ...
    """,
    f"""
        CREATE TABLE `{GROUPS_TABLE_PATH}`
        (
            `chat_id` Int64,
            `language` String,
            `group_id` String,
    ...
    """,
    f"""
        CREATE TABLE `{LANGUAGES_TABLE_PATH}`
        (
            `chat_id` Int64,
            `language` String,
    ...
    """,
    f"""
        CREATE TABLE `{TRAINING_SESSIONS_INFO_TABLE_PATH}`
        (
            `chat_id` Int64,
            `session_id` Uint64,
            `direction` String,
    ...
    """,
    f"""
        CREATE TABLE `{TRAINING_SESSIONS_TABLE_PATH}`
        (
            `chat_id` Int64,
            `session_id` Uint64,
            `word_idx` Uint64,
    ...
    """,
    f"""
        CREATE TABLE `{STATES_TABLE_PATH}`
        (
            `chat_id` Int64,
            `state` Utf8,
            PRIMARY KEY (`chat_id`)
    ...
    """,
    f"""
        CREATE TABLE `{VOCABS_TABLE_PATH}`
        (
            `chat_id` Int64,
            `language` String,
            `word` Utf8,
